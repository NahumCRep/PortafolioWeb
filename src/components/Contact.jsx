        ...
        <section id="section-contact" className="Contact-Container">
            <div className="Cct-form">
                <form name="contact" method="POST" data-netlify="true" netlify-honeypot="bot-field" onSubmit={e => sendEmail(e)} >
                    ...
                    <input type="text" aria-label='name' name='name' placeholder={t("contact.phname")} onChange={handleChange} value={formData.name} required />
                    <input type="email" aria-label='email' name='email' placeholder={t("contact.phemail")} onChange={handleChange} value={formData.email} required />
